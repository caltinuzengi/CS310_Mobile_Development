 ...
 * Use the {@link PoliticsFragment#} factory method to
...
public class PoliticsFragment extends Fragment {
    ...
    Handler dataHanler = new Handler(new Handler.Callback() {
        ...
        public boolean handleMessage(@NonNull Message message) {
            ...
            recyclerViewPolitics.setAdapter(adp);
            recyclerViewPolitics.setVisibility(View.VISIBLE);
...
//    }
    ...
    public void findNews(){
        ...
        repo.GetNewsByCategoryId(((NewsApplication)getActivity().getApplication()).srv, dataHanler, 3);
